...
from model.resnet18 import Resnet_Dis
...
parser.add_argument('-classes_DR', default=4, type=int, metavar='N', help='bumber of DR grading classes')
...
def main(time_str):
    ...
    train_dataset = Dataset(txt_root='/home/zouwei/dataset/dataset_cross_train.txt',
    ...
    test_dataset = Dataset(txt_root='/home/zouwei/dataset/dataset_cross_test.txt',
                           transform=torchvision.transforms.Compose([
                               transforms.Resize(256),
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train_acc_DR, train_los_DR, train_acc_DME, train_los_DME = train(train_loader, model, estimator, criterion, optimizer, optimizer_estimate, epoch, args)
...
def train(train_loader, model, estimator, criterion, optimizer, optimizer_estimate, epoch, args):
    ...
    progress = ProgressMeter(len(train_loader),
                             [losses_DR, losses_DME, losses_mi, top1_DR, top1_DME],
